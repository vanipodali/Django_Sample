...
create_subject_query = 'CREATE TABLE subjects (subject_id int,subject_name varchar(100) DEFAULT NULL) '
database_operations.create_tables(create_subject_query)
...
database_operations.insert_marks(insert_marks_query)
